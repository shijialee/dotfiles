...
function! Perl_Run ()
	...
	if s:Perl_OutputGvim == "vim"
		"
		if	s:MSWIN
			exe "/home/qiangli/perl/5.8.8/bin/perl \"".l:switches.l:fullname." ".l:arguments."\""
		else
			exe "/home/qiangli/perl/5.8.8/bin/perl ".l:switches.l:fullname.l:arguments
		endif
		"
...
function! Perl_Debugger ()
	...
	if s:Perl_Debugger == "perl"
		if	s:MSWIN
			silent exe "/home/qiangli/perl/5.8.8/bin/perl -d \"".Sou.l:arguments."\""
		else
	...
	if s:Perl_Debugger == "ptkdb"
		if	s:MSWIN
			silent exe "/home/qiangli/perl/5.8.8/bin/perl -d:ptkdb \"".Sou.l:arguments."\""
		else
			silent exe '/home/qiangli/perl/5.8.8/bin/perl -d:ptkdb  ./'.Sou.l:arguments.' &'
		endif
	endif
...
function! Perl_Smallprof ()
	...
	silent exe	"/home/qiangli/perl/5.8.8/bin/perl -d:SmallProf ".Sou
	"
	if v:shell_error
		redraw
